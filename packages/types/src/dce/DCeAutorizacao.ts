...
export interface DCEAutorizacaoPayload {
    /**
     * XML completo da DCe pronto para transmissao.
     */
    xml?: string;
    /**
     * Objeto da declaracao; sera serializado para a tag raiz DCe.
     */
    dce?: Record<string, unknown>;
    /**
     * Alias para compatibilidade com nomenclatura da tag raiz.
     */
    DCe?: Record<string, unknown>;
    /**
     * Versao da mensagem do servico.
     */
    versao?: string;
}
