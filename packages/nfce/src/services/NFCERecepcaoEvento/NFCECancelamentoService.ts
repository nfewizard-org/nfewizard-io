...
import NFCERecepcaoEventoService from './NFCERecepcaoEventoService.js';
import { GerarConsultaImpl, SaveFilesImpl } from '@nfewizard/types/shared';

export class NFCECancelamentoService extends NFCERecepcaoEventoService {
    constructor(environment: Environment, utility: Utility, xmlBuilder: XmlBuilder, axios: AxiosInstance, saveFiles: SaveFilesImpl, gerarConsulta: GerarConsultaImpl) {
        super(environment, utility, xmlBuilder, axios, saveFiles, gerarConsulta);
    }
}

export default NFCECancelamentoService;
