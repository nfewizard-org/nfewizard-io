...
import {
    ...
    EPEC,
    EmailParams,
} from 'src/old/protocols';
import NFEGerarDanfe from 'src/old/controllers/Danfe/NFEGerarDanfe';
import NFEDistribuicaoDFePorUltNSU from 'src/old/controllers/DFe/NFe/NFEDistribuicaoDFe/NFEDistribuicaoDFePorUltNSU';
import NFEDistribuicaoDFePorNSU from 'src/old/controllers/DFe/NFe/NFEDistribuicaoDFe/NFEDistribuicaoDFePorNSU';
import NFEDistribuicaoDFePorChave from 'src/old/controllers/DFe/NFe/NFEDistribuicaoDFe/NFEDistribuicaoDFePorChave';
import NFECancelamento from 'src/old/controllers/DFe/NFe/NFERecepcaoEvento/NFECancelamento';
import NFECienciaDaOperacao from 'src/old/controllers/DFe/NFe/NFERecepcaoEvento/NFECienciaDaOperacao';
import NFEConfirmacaoDaOperacao from 'src/old/controllers/DFe/NFe/NFERecepcaoEvento/NFEConfirmacaoDaOperacao';
import NFEOperacaoNaoRealizada from 'src/old/controllers/DFe/NFe/NFERecepcaoEvento/NFEOperacaoNaoRealizada';
import NFECartaDeCorrecao from 'src/old/controllers/DFe/NFe/NFERecepcaoEvento/NFECartaDeCorrecao';
import NFEDesconhecimentoDaOperacao from 'src/old/controllers/DFe/NFe/NFERecepcaoEvento/NFEDesconhecimentoDaOperacao';
import NFEEpec from 'src/old/controllers/DFe/NFe/NFERecepcaoEvento/NFEEpec';
import { AxiosInstance } from 'axios';
import MailController from 'src/old/controllers/Email/MailController';
import NFCEAutorizacao from 'src/old/controllers/DFe/NFe/NFCEAutorizacao/NFCEAutorizacao';
import NFCEGerarDanfe from 'src/old/controllers/Danfe/NFCEGerarDanfe';
