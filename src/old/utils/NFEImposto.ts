 ...
 */
import { COFINS, ICMS, PIS, dadosCOFINS, dadosICMS, dadosPIS } from 'src/old/protocols';
...
export const mountICMS = (icms: dadosICMS): ICMS => {
    ...
    const requiredFields = {
        ...
        ICMS90: ['orig', 'CST', 'modBC', 'pRedBC', 'vBC', 'pICMS', 'vICMS', 'vBCST', 'pICMSST', 'vICMSST', 'vICMSDeson', 'motDesICMS', 'indDeduzDeson', 'modBCST', 'pMVAST', 'pRedBCST'],
